...
SERVICES = [
    ...
    {"name": "screen-ITS01", "cmd": [_PY, "screen_client.py", "ITS01", "Graha"]},
    {"name": "screen-ITS02", "cmd": [_PY, "screen_client.py", "ITS02", "Library"]},
    {"name": "screen-ITS03", "cmd": [_PY, "screen_client.py", "ITS03", "Research"]},
    {"name": "screen-ITS04", "cmd": [_PY, "screen_client.py", "ITS04", "Canteen"]},
